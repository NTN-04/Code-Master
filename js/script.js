...
function initProgressBars() {
    ...
    progressBars.forEach(bar => {
        ...
        const storedProgress = localStorage.getItem(`course-progress-${courseId}`) || 0;
...
function initScrollAnimations() {
    const elementsToAnimate = document.querySelectorAll('.course-card, .path-card, .resource-card');
